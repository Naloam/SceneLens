...
class MainActivity : ReactActivity() {
  ...
  override fun onReactInstanceManagerCreated() {
    super.onReactInstanceManagerCreated()
    
    // Handle pending shortcut intent if any
    pendingShortcutIntent?.let { intent ->
      handleShortcutIntent(intent)
      pendingShortcutIntent = null
    }
  }
